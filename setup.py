...
#
# Adapted from huggingface/transformers: transformers/setup.py at 21a2d900eceeded7be9edc445b56877b95eda4ca · huggingface/transformers
...
# Remove stale alignment.egg-info directory to avoid Pip picks up .egg-info from sub-folders in -e mode · Issue #5466 · pypa/pip
...
if stale_egg_info.exists():
    print(
        (
            ...
            "See Pip picks up .egg-info from sub-folders in -e mode · Issue #5466 · pypa/pip for details.\n"
...
setup(
    ...
    license="Apache",
    url="GitHub - huggingface/alignment-handbook: Robust recipes to align language models with human and AI p",
    package_dir={"": "src"},
